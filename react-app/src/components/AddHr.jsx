  ...
  return (
    <>
        <button className="text-sm font-bold hover:bg-gray-200 p-2 rounded-md" onClick={()=>{setIsOpen(true)}}>
          <i className="fa-regular fa-plus pr-2"></i>Add HR employee
        </button>
                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5">
                        <form className="space-y-4" action="#">
                            ...
                            <button type="button" className="w-full text-white bg-[#007cff] hover:bg-[] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={()=>{createHr()}}><i className={`${isLoading? "fa-duotone fa-spinner-third fa-spin": "fa-regular fa-plus"} mr-2`}></i>Add HR employee</button>
                        </form>
                    </div>
                </div>
            </div>
